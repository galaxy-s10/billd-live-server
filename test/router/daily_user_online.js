...
async function foo() {
  const result = await autocannon({
    url: `${baseUrl}/daily_user_online/accumulate?orderName=user_id&orderBy=desc&live_room_id=7&rangTimeType=created_at&rangTimeStart=1705405285510&rangTimeEnd=1706010085510&pageSize=10&nowPage=1`,
    method: 'GET',
  ...
  // const result = await autocannon({
  //   url: `${baseUrl}/daily_user_online/accumulate?orderName=user_id&orderBy=desc&live_room_id=7&rangTimeType=created_at&rangTimeStart=1703417921552&rangTimeEnd=1706009921552&parent_user_id=5&pageSize=10&nowPage=1`,
  //   method: 'GET',
  //   connections: 10, // 并发连接数。可选默认值：10
  //   pipelining: 1, // 每个连接的管道请求数。当大于 1 时将导致ClientAPI 抛出异常。可选默认值：1
  //   duration: 5, // 运行的秒数。可以是时间字符串。可选默认值：10
  ...
  // });
  // const result = await autocannon({
  //   url: `${baseUrl}/daily_user_online/accumulate?orderName=updated_at&orderBy=desc&live_room_id=7&rangTimeType=updated_at&rangTimeStart=1705399295517&rangTimeEnd=1706004095517&pageSize=10&nowPage=1`,
  //   method: 'GET',
  //   connections: 10, // 并发连接数。可选默认值：10
  //   pipelining: 1, // 每个连接的管道请求数。当大于 1 时将导致ClientAPI 抛出异常。可选默认值：1
  //   duration: 5, // 运行的秒数。可以是时间字符串。可选默认值：10
  ...
  // });
  // const result = await autocannon({
  //   url: `${baseUrl}/daily_user_online/list?orderName=created_at&orderBy=desc&live_room_id=7&rangTimeType=created_at&rangTimeStart=1705398931355&rangTimeEnd=1706003731355&pageSize=10&nowPage=1`,
  //   method: 'GET',
  //   connections: 10, // 并发连接数。可选默认值：10
  //   pipelining: 1, // 每个连接的管道请求数。当大于 1 时将导致ClientAPI 抛出异常。可选默认值：1
  //   duration: 5, // 运行的秒数。可以是时间字符串。可选默认值：10
  ...
  // });
  // const result = await autocannon({
  //   url: `${baseUrl}/daily_user_online/peak?orderName=format_date&orderBy=desc&rangTimeType=format_date&rangTimeStart=1705398553665&rangTimeEnd=1706003353665&pageSize=10&nowPage=1`,
  //   method: 'GET',
  //   connections: 10, // 并发连接数。可选默认值：10
  //   pipelining: 1, // 每个连接的管道请求数。当大于 1 时将导致ClientAPI 抛出异常。可选默认值：1
  //   duration: 5, // 运行的秒数。可以是时间字符串。可选默认值：10
