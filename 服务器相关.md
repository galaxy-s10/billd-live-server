...
-v /Users/huangshuisheng/Desktop/docker/redis/users.acl:/etc/redis/users.acl \
...
-p 6379:6379 \
--name billd-live-redis \
-v /node/docker/redis/data:/data \
-v /node/docker/redis/redis.conf:/etc/redis/redis.conf \
-v /node/docker/redis/users.acl:/etc/redis/users.acl \
redis:7.0 redis-server /etc/redis/redis.conf
```
